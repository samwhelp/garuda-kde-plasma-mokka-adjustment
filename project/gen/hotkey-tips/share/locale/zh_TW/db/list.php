...
*/
	...
	$item['Action'] = "開啟檔案管理器 (pcmanfm-qt)";
	$list[] = $item;
	...
	$item['Action'] = "開啟網頁瀏覽器 (firedragon)";
	$list[] = $item;
...
*/
	...
	$item['Action'] = "開啟 DropDown Terminal (yakuake)";
	$list[] = $item;
