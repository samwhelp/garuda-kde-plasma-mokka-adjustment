...
"Alt + Shift + b" "開啟網頁瀏覽器 (firedragon)" "#ffffff" "Monospace 16" \
...
"Alt + Ctrl + t" "開啟 Terminal (konsole)" "#ffffff" "Monospace 16" \
...
"Win + t" "視窗 / 保持永遠在最上方" "#cccccc" "Monospace 16" \
"Win + b" "視窗 / 保持永遠在最下方" "#ffffff" "Monospace 16" \
"Win + y" "視窗 / 內容區塊收合" "#cccccc" "Monospace 16" \
"Win + n" "視窗 / 切換顯示隱藏視窗裝飾" "#ffffff" "Monospace 16" \
"Win + z" "將下方視窗移上來" "#cccccc" "Monospace 16" \
"Win + m" "視窗 / 移動至畫面中央部位" "#ffffff" "Monospace 16" \
"Win + ;" "視窗 / 更加透明" "#cccccc" "Monospace 16" \
"Win + '" "視窗 / 更不透明" "#ffffff" "Monospace 16" \
